...
struct block_data_t : mesh::block::base_data_t
{
    ...
    __host__ virtual void setup( const f_new_t & f_n )
    {
        ...
        // Line-centre emissivity (always allocated; read from the
        // field file, used only by the imaging pass).
...
struct prx_t : particle::radiation::proxy_t< block_data_t >
{
      ...
      ::particle::base_t       & mod ) override
    {
        auto & b_d( ref( d.d(  ) ) );
        rad = b_d.rad;
        return particle::proxy_base_t::setup
            ( d, m_rank, mod );
    }
};
